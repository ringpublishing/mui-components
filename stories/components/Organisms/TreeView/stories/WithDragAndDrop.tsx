...
import WithDragAndDropExampleCode from './code/WithDragAndDropExample.tsx?raw';
...
import { moveItems, checkItem } from '../common/helpers.js';
...
export const WithDragAndDrop: Story = {
    ...
    render: (args, context) =>
        createCodeStory({
            context,
            customCode: WithDragAndDropExampleCode,
