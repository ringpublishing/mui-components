...
import AutoRefreshInitiallyDisabledExampleCode from './code/AutoRefreshInitiallyDisabledExample.tsx?raw';
...
export const AutoRefreshInitiallyDisabled: Story = {
    args: {
        autoRefresh: true,
        refreshRate: 5000,
    ...
    render: (args, context) => {
        ...
        return createCodeStory({
            ...
            customCode: AutoRefreshInitiallyDisabledExampleCode,
        });
    },
};
