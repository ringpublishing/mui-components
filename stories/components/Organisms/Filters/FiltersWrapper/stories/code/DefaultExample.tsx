...
import { Accordion, Autocomplete, DatePicker, FiltersWrapper } from '@ringpublishing/mui-components';
...
export default function DefaultExample(): React.JSX.Element {
    ...
    return (
        <FiltersWrapper label="Filters" withClearButton={true} clearButtonLabel="Clear" onClear={handleOnClear}>
            <Accordion label="Basic" defaultExpanded={true}>
                ...
                <MuiAutocomplete
                    ...
                    renderInput={(params): React.JSX.Element => <TextField {...params} label="Autocomplete" />}
                />
            </Accordion>
