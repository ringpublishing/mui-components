...
import WithAdditionalExtensionsExampleCode from './code/WithAdditionalExtensionsExample.tsx?raw';
import {
    TextEditor,
...
const sampleTextWithAdditionalExtensions = `
    <h1>Heading 1</h1>
...
export const WithAdditionalExtensions: Story = {
    render: (args, context) =>
        createCodeStory({
            context,
            customCode: WithAdditionalExtensionsExampleCode,
            example: (
                <TextEditorWrapper
                    content={sampleTextWithAdditionalExtensions}
